...
o.datatype="port"
o.optional = false
o.description = translate("<input type=\"button\" style=\"width:210px;border-color:Teal; text-align:center;font-weight:bold;color:Green;\" value=\"AdGuardHome Web\" onclick=\"window.open('http://'+window.location.hostname+':"..httpport.."/')\"/>")
...
o.default     = "/opt/AdGuardHome/AdGuardHome"
o.datatype    = "string"
o.optional = false
o.rmempty=false
...
o.default     = "/opt/AdGuardHome/config.yaml"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
local workdir=uci:get("AdGuardHome","AdGuardHome","workdir") or "/opt/AdGuardHome"
